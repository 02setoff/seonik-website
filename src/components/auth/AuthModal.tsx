          ...
          <>
            ...
            <div style={{ margin: "20px 0 0", display: "flex", flexDirection: "column", gap: "12px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                <span style={{ fontSize: "11px", color: "#94A3B8", fontFamily: "'Pretendard', sans-serif", whiteSpace: "nowrap" }}>또는</span>
                <div style={{ flex: 1, height: "1px", backgroundColor: "#E2E8F0" }} />
              </div>
              <button
                type="button"
                ...
                style={{
                  ...
                  fontSize: "14px", fontFamily: "'Pretendard', sans-serif", color: "#0F172A",
