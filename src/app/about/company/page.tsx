  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "clamp(40px,8vw,64px) clamp(20px,5vw,40px) 96px" }}>
        ...
        {NAV.map((item) => (
          <Link key={item.href} href={item.href}
            style={{
              ...
              color: item.href === "/about/company" ? "var(--text-primary)" : "var(--text-placeholder)",
              fontWeight: item.href === "/about/company" ? 700 : 400,
              textDecoration: "none",
              borderBottom: item.href === "/about/company" ? "2px solid var(--text-primary)" : "2px solid transparent",
      ...
      <div style={{ marginBottom: "56px" }}>
        ...
        <h1 style={{ fontSize: "32px", fontFamily: "'Pretendard', sans-serif", fontWeight: 800, color: "var(--text-primary)", marginBottom: "0" }}>
          회사명
        </h1>
      </div>
      ...
      <div style={{ marginBottom: "48px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "28px" }}>
          <div style={{ border: "1px solid var(--border)", padding: "28px 24px", textAlign: "center", backgroundColor: "var(--bg-card)" }}>
            <p style={{ fontSize: "40px", fontFamily: "'Pretendard', sans-serif", fontWeight: 800, color: "var(--text-primary)", marginBottom: "12px" }}>先</p>
            <p style={{ fontSize: "13px", fontFamily: "Inter, sans-serif", color: "var(--text-placeholder)", letterSpacing: "0.1em", marginBottom: "8px" }}>FIRST</p>
            <p style={{ fontSize: "15px", fontFamily: "'Pretendard', sans-serif", fontWeight: 600, color: "var(--text-primary)", marginBottom: "6px" }}>먼저</p>
            <p style={{ fontSize: "13px", fontFamily: "'Pretendard', sans-serif", color: "var(--text-muted)", lineHeight: "1.6", margin: 0 }}>
              남보다 먼저 알고, 먼저 움직인다
            </p>
          </div>
          <div style={{ border: "1px solid var(--border)", padding: "28px 24px", textAlign: "center", backgroundColor: "var(--bg-card)" }}>
            <p style={{ fontSize: "40px", fontFamily: "'Pretendard', sans-serif", fontWeight: 800, color: "var(--text-primary)", marginBottom: "12px" }}>益</p>
            <p style={{ fontSize: "13px", fontFamily: "Inter, sans-serif", color: "var(--text-placeholder)", letterSpacing: "0.1em", marginBottom: "8px" }}>BENEFIT</p>
            <p style={{ fontSize: "15px", fontFamily: "'Pretendard', sans-serif", fontWeight: 600, color: "var(--text-primary)", marginBottom: "6px" }}>이롭다</p>
            <p style={{ fontSize: "13px", fontFamily: "'Pretendard', sans-serif", color: "var(--text-muted)", lineHeight: "1.6", margin: 0 }}>
              알면 이롭고, 이기고, 성장한다
            </p>
          </div>
        </div>
        <div style={{ padding: "24px 28px", borderLeft: "3px solid var(--text-primary)", backgroundColor: "var(--bg-subtle)" }}>
          <p style={{ fontSize: "16px", fontFamily: "'Pretendard', sans-serif", color: "var(--text-primary)", lineHeight: "1.8", margin: 0 }}>
      ...
      <div style={{ marginBottom: "48px" }}>
        ...
        <p style={{ fontSize: "15px", fontFamily: "'Pretendard', sans-serif", color: "var(--text-secondary)", lineHeight: "1.9", marginBottom: "16px" }}>
          영문 표기 <strong style={{ color: "var(--text-primary)", fontFamily: "Inter, sans-serif" }}>SEONIK</strong>은 한국어 발음 &ldquo;선익&rdquo;을 로마자 표기한 것으로,
      ...
      <div style={{ borderTop: "1px solid var(--border-light)", paddingTop: "32px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <Link href="/about/vision" style={{ fontSize: "13px", color: "var(--text-muted)", fontFamily: "'Pretendard', sans-serif", textDecoration: "none" }}>
          ← 비전
        </Link>
        <p style={{ fontSize: "12px", color: "var(--text-placeholder)", fontFamily: "Inter, sans-serif" }}>
          先益 — 앞서나가는 정보로 실행가들을 이롭게
        </p>
        <Link href="/about/slogan" style={{ fontSize: "13px", color: "var(--text-primary)", fontFamily: "'Pretendard', sans-serif", textDecoration: "none", fontWeight: 600 }}>
          슬로건 →
        </Link>
      </div>
    </div>
